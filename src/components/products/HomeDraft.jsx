...
import { FaArrowRight, FaBookOpen, FaCalendarAlt, FaGraduationCap, FaPlay, FaQuoteLeft, FaQuoteRight, FaWhatsapp, FaStar, FaYoutube, FaCheck, FaClock, FaUsers, FaHeart } from "react-icons/fa";
...
const HomePageDraft = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['featured-product', 'courses', 'products', 'testimonials', 'youtube'];
  ...
  // Featured Product - Riyaz Planner
  ...
  const products = [
    { 
      ...
      rating: 4.8,
      type: "study guide",
      description: "Comprehensive preparation material for UGC-NET Music examination with detailed coverage of all topics",
      features: ["Complete syllabus coverage", "Previous year papers", "Practice questions", "Expert guidance"]
    },
    { 
      id: 3, 
      ...
      rating: 4.5,
      type: "study guide",
      description: "Specialized study material for Rajasthan Public Service Commission Music Teacher posts",
      features: ["Rajasthan syllabus focused", "State-specific content", "Mock tests included", "Updated curriculum"]
    },
    { 
      id: 4, 
      ...
      rating: 4.9,
      type: "study guide", 
      description: "Complete preparation guide for TGT-PGT Music Teacher eligibility examinations",
      features: ["Teaching methodology", "Music theory & practical", "Pedagogy concepts", "Exam strategies"]
    }
  ];
  ...
  return (
    <div className="font-['Merriweather', serif] mt-10 md:mt-0 bg-[#F5E6C8] text-[#4A1A1A] overflow-x-hidden">
      ...
      {/* FEATURED PRODUCT SECTION - RIYAZ PLANNER */}
      ...
      <section id="products" className="py-20 px-6 md:px-24 bg-white">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-5xl font-bold mb-6">Study Materials & Resources</h2>
          <div className="bg-[#c67f00] h-1 w-24 mx-auto rounded-full mb-6"></div>
          <p className="text-gray-700 max-w-2xl mx-auto">
            Elevate your preparation with our expertly crafted study materials for competitive music examinations
          </p>
        </motion.div>
              ...
              <div className="p-6 border-t border-[#E5D6B8]">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="bg-[#25D366] text-white px-4 py-2 rounded-full flex items-center gap-2 hover:bg-[#20BD59] transition text-sm">
