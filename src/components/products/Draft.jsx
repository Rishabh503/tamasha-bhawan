...
import planner2 from "../../../public/planner2.jpg"
const ProductPage = () => {
  ...
  const product = {
    ...
    features: [
      ...
      "Design Your own Muiscal Vision Board",
    ...
    //   "Binding": "Hardcover with elastic band",
    //   "Digital Access": "Lifetime access to companion app",
    //   "Audio Content": "2.5 hours of guided practice sessions",
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <div className="mb-6">
                <img 
                  ...
                  alt={product.name}
                  className="w-full h-108 object-cover rounded-lg"
                />
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <p className="mt-6 text-[#c67f00] hover:underline font-medium">
                And Many More...
              </p>
            </motion.section>
          </div>
            ...
            {relatedProducts.map((item) => (
              <div key={item.id} className="bg-[#F8F1E7] p-6 rounded-lg hover:shadow-lg transition">
                <div className="flex justify-center mb-4">
                  <img src={item.img} alt={item.name} className="h-16 object-cover" />
                </div>
