...
import { FaArrowRight, FaCheck ,FaHeart ,FaBookOpen, FaCalendarAlt, FaClock, FaGraduationCap, FaPlay, FaQuoteLeft, FaQuoteRight, FaShoppingCart, FaStar, FaUsers, FaWhatsapp, FaYoutube } from "react-icons/fa";
...
const HomePage = () => {
  ...
  return (
    <div className="font-['Merriweather', serif] mt-10 md:mt-0 bg-[#F5E6C8] text-[#4A1A1A] overflow-x-hidden">
     ...
     <section id="featured-product" className="py-20 px-6 md:px-24 bg-gradient-to-br from-[#4A1A1A] to-[#2A0E0E] text-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              The ultimate practice companion for every Indian classical music student
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <FaStar key={i} className={i < Math.floor(featuredProduct.rating) ? "text-yellow-400" : "text-gray-400"} />
                      ))}
                    </div>
                    <span className="text-yellow-400 font-bold">{featuredProduct.rating}</span>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-300 text-lg mb-6">{featuredProduct.shortDescription}</p>
              </div>

              {/* Pricing */}
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-4xl font-bold text-[#c67f00]">{featuredProduct.price}</span>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button 
                    onClick={() => handleWhatsAppOrder(featuredProduct.name, featuredProduct.price)}
